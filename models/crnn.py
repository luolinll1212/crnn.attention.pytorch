...
#     batch_size = 2
#     x = torch.randn(batch_size, 3, 32, 280)
#     encoder = Encoder(3, 512)
#     encoder.apply(utils.weights_init)
#     out_encoder = encoder(x)
#     print(out_encoder.size())
#
#     labels = torch.LongTensor([[22,21,44,66],[33,44,21, 0]])
#     decoder = Decoder(hidden_size=512, output_size=2000)
#     decoder.apply(utils.weights_init)
#     decoder_hidden = decoder.initHidden(batch_size)
#     decoder_output, decoder_hidden, decoder_attention = decoder(labels, decoder_hidden, out_encoder)
